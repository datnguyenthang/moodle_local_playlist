<?php
// This file is part of Playlist Competence Grid
//
// (c) 2023 GTN - Global Training Network GmbH <office@gtn-solutions.com>
//
// Playlist Competence Grid is free software: you can redistribute it and/or modify
...
namespace local_playlist\common {
...
namespace {
	function _local_playlist_export_function($function) {
	...
	if (_local_playlist_export_function('get_string')) {
		function local_playlist_get_string($identifier, $component = null, $a = null) {
            return '';
		}
	}
	if (_local_playlist_export_function('trans')) {
		function local_playlist_trans($string_or_strings, $arg_or_args = null) {
            return '';
		}
	}
}
